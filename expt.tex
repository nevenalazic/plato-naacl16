...
\end{tabular}
\caption{\label{table:examples} Examples of gains by our algorithm, showing the resolved mention,
the entities the mention resolves to in the baseline model and in the attention model,
and the attention focus mentions in the document. }
\end{table*}
