...
pages), Freebase aliases, and Wikipedia anchor text.  \todo{wikilinks?}
...
attention model is resilient and beats \newcite{Chisholm2015} by over
1.9\% absolute accuracy, or a 17\% relative reduction in error.

The bottom block concerns HP aliases.  Low ambiguity, coupled with
