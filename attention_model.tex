...
The parameters $\ws,\wp$ are learned from labeled data, as explained next. Since inference decomposes over mentions, we use a simple hinge loss for each mention. The loss is defined as follows. Denote by $y^*_i$ the ground
